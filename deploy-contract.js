...
var fs = require("fs");
var network = new network_1.StacksTestnet();
var txOptions = {
...
function deployContract() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, transactions_1.makeContractDeploy(txOptions)];
                case 1:
                    transaction = _a.sent();
                    return [4 /*yield*/, transactions_1.estimateContractDeploy(transaction, network)];
                case 2:
                    _a.sent();
